    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Kegiatan</h1>
...
<?php 
    if(isset($_POST['tambah'])){
        ...
        $d = mysqli_query($koneksi, "insert into tb_kegiatan value('$id_kegiatan', '$tgl_kegiatan', '$kegiatan', '$deskripsi', '$id_user', '$gambar')");
