    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Ubah Data Kegiatan</h1>
                <form method="POST" action="" enctype="multipart/form-data">
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal Kegiatan</label>
                <div class="col-sm-10">
                <input type="date" class="form-control" id="inputPassword3" name="tgl_kegiatan" value="<?php echo $r['tgl_kegiatan']?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Kegiatan</label>
                <div class="col-sm-10">
                <input type="tel" class="form-control" id="inputPassword3" name="kegiatan" value="<?php echo $r['kegiatan']?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Deskripsi</label>
                <div class="col-sm-10">
                <textarea class="form-control" id="inputPassword3" name="deskripsi"><?php echo $r['deskripsi']?></textarea>
                </div>
            </div>
            <div class="row mb-3">
...
<?php 
    if(isset($_POST['ubah'])){
        ...
        if(empty($gambar)){
            ...
            $d = mysqli_query($koneksi, "UPDATE tb_kegiatan SET  tgl_kegiatan='$tgl_kegiatan', gambar='$kegiatan', deskripsi='$deskripsi', id_user='$id_user', gambar='$gambar'  WHERE id_kegiatan = '$id'");
