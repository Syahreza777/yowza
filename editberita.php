    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="inputPassword3" name="judul" value="<?php echo $r['judul']?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Tanggal Post</label>
                <div class="col-sm-10">
                <input type="date" class="form-control" id="inputPassword3" name="tgl_post" value="<?php echo $r['tgl_post']?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <textarea class="form-control" id="inputPassword3" name="isi_berita"><?php echo $r['isi_berita']?></textarea>
                </div>
            </div>
            <div class="row mb-3">
